...
namespace STS2
{
    // NOTE: You can use the "Rename" command on the "Refactor" menu to change the class name "CustomSTS" in code, svc and config file together.
    // NOTE: In order to launch WCF Test Client for testing this service, please select CustomSTS.svc or CustomSTS.svc.cs at the Solution Explorer and start debugging.
    public class CustomSTS : ICustomSTS
    { 
        ...
        public CustomSTS(string stsName, X509SecurityToken issuerToken, X509SecurityToken encryptionToken)
        {
        ...
        /// </summary>
        protected virtual Collection<SamlAttribute> GetIssuedClaims(RequestSecurityToken requestSecurityToken)
        {
        ...
        public virtual void AddAudienceRestrictionCondition(SamlConditions samlConditions)
        {
